...
class StickerPack {
    ...
    func addSticker(contentsOfFile filename: String, emojis: [String]?) throws {
        ...
        let sticker: WSticker = try WSticker(contentsOfFile: filename, emojis: emojis)
    ...
    func addSticker(imageData: Data, type: ImageDataExtension, emojis: [String]?) throws {
        ...
        let sticker: WSticker = try WSticker(imageData: imageData, type: type, emojis: emojis)
    ...
    func sendToWhatsApp(completionHandler: @escaping (Bool) -> Void) {
        StickerPackManager.queue.async {
            ...
            json["ios_app_store_link"] = "https://apps.apple.com/app/avatar-stickers-for-telegram/id1574023061"
